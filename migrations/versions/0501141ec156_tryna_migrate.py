...
Revision ID: 0501141ec156
Revises: d76e3752f266
Create Date: 2025-01-19 21:25:55.717829
...
revision = '0501141ec156'
down_revision = 'd76e3752f266'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.alter_column(
    'goals', 'status',
    existing_type=sa.Enum('in_progress', 'completed', 'on_hold', 'cancelled', name='goalstatus'),
    type_=sa.Enum('IN_PROGRESS', 'COMPLETED', 'ON_HOLD', 'CANCELLED', name='goalstatus'),
